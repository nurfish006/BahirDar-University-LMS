...
<div >
<h1 className='text-black max-w-[900px] text-left'>Welcome to our computer Studnt home page</h1>
<h4 className=' text-blue max-w-[600px] '>thanks for joing dear student thanks for joing dear student thanks for joing dear studentthanks for joing dear student</h4>
...
const links = [
  { name: 'My Course', href: '/student/course' },
  { name: 'Class', href: '/student/ce/class' },
  { name: 'Get Course Resources', href: '/student/ce/coursemateria' },
  { name: 'Chat With Others', href: '/student/ce/chat' },
]
const stats = [
    ...
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Lear with us</h2>
