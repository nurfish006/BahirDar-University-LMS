...
import Navbar from './ee/EeTeacherNav'
    ...
    try {
      ...
      if (title.trim() !== '' && description.trim() !== '') {
        if (file) {
          ...
          setErrorMsg('');
          await axios.post(`${API_URL}/eeupload`, formData, {
            headers: {
              'Content-Type': 'multipart/form-data'
            }
          });
          // props.history.push('/list');
          toast.success('mateial added successfully');
          navigate("/teacher/ee/materials")
        } else {
