    ...
    <nav className='navbar'>
      ...
      <h3 className='logo'>
        ...
        <ul className= {Mobile? "nav-links-mobile" : 'nav-links'} onClick={() =>setMobile(false)}>
          <Link to='/teacher/ee'><li>HOME</li></Link>
          <Link to='/teacher/ee/addcoursematerial'><li>ADD MATERIALS</li></Link>
          {/* <Link to='/coursematerial'><li>COURSE MARERIAL</li></Link> */}
          <Link to='/teacher/ee/class'><li>CLASS</li></Link>
          <Link to='/teacher/ee/materials'><li>Materials</li></Link>
          <Link to='/teacher/ee/assignment'><li>ASSIGNMENT</li></Link>
          <Link to='/teacher/ee/news'><li>News</li></Link>
          <Link to='/teacher/ee/chat'><li>CHAT</li></Link>
          <Link to='/teacher/ee/addnews'><li>Add News</li></Link>
        </ul>
        {teacher !== null && (
              <SubMenu
                icon={<CgProfile />}
