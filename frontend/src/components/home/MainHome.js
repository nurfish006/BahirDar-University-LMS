  ...
  return (
    <div>
      <main className="container mx-auto px-4 h-screen">
        <h1 className="text-4xl font-bold text-gray-800 mb-8 pr-8">
          BahirDar University Learning Management System 
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md rounded-md overflow-hidden">
            ...
            <div className="p-4">
              <h2 className="text-lg font-semibold text-gray-800 ">
                Learn Online, Save Your Time
              </h2>
              <p className="text-gray-600 mb-4">
                We are here to give you more comfort
              </p>
            </div>
          </div>
          ...
          <div className="bg-white shadow-md rounded-md overflow-hidden">
            ...
            <div className="p-4">
              <h2 className="text-lg font-semibold text-gray-800 ">
                Expriance everything from your home
              </h2>
              <p className="text-gray-600 mb-4">
                With out leaving your home go beyond your imaginary line.
              </p>
            </div>
          </div>
