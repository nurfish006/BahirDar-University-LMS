...
<div >
<h1 className='text-black max-w-[900px] text-left'>Wellcome to our Head home page</h1>
<p className='max-w-[500px] '> Dear Head We would like to thank for being here, now enjoy our web</p>
...
const links = [
  { name: 'News ', href: '/head/ce/news' },

  { name: 'Add News ', href: '/head/ce/addnews' },
  { name: 'Chat With Others', href: '/head/ce/chat' },
]
const stats = [
  { name: 'Head', value: 'Management' },
    ...
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Manage your activities with us</h2>
