...
const File = require('../models/eefile');
...
Router.get('/getAlleeFiles', async (req, res) => {
  try {
...
Router.get('/downloadee/:id', async (req, res) => {
  try {
...
//delete
Router.delete('/deleteFileee/:id', async (req, res) => {
  try {
    const { id } = req.params;
